...
//    public static double[] distancesFromStartcity;
//    public static double[] distancesToStartcity;
    ...
    public static void main(List<String> cityNames, List<String> distances, int startAndEndIndex) {
        ...
        for (int i = 0; i < numCities; i++) {
            ...
            var l = IntStream.range(from, to).mapToObj(list::get).collect(toList());
            cities[i] = new City(i, cityNames.get(i), l, startAndEndIndex);
        }
